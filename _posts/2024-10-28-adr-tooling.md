...
- [ADG (Architectural Decision Guidance)](https://github.com/adr/ad-guidance-tool), a command-line tool written in Go for modeling, managing, and reusing architectural decisions in a lightweight and structured way. Template options: Nygard, MADR (basic), QOC.
...
- [Archcore](https://github.com/archcore-ai/archcore), a git-native context engineering CLI and MCP server for AI coding agents that keeps specs, ADRs, rules, plans, and project knowledge in Git.
